...
type DirectionRouteProp = RouteProp<RootStackParamList, 'DirectionGroupScreen'>;
...
const DirectionGroupScreen = () => {
    ...
    const fetchDirection = async () => {
        try {
            ...
            const response = await axiosInstance.get(`/shipment-group/view/map_direction/${shipmentId}`, {
                        ...
                        <>
                            <View style={styles.statusBox}>
                                ...
                                <View style={styles.statusLabels}>
                                    <Text style={styles.statusLabel}>{t('orderContent.status.wait')}</Text>
                                    <Text style={styles.statusLabel}>{t('orderContent.status.ship')}</Text>
                                    <Text style={styles.statusLabel}>{t('orderContent.status.complete')}</Text>
                                </View>
                            </View>
                            <Text style={styles.stepHeader}>{t('common.route')}:</Text>
                        </>
                    }
                    data={steps}
...
export default DirectionGroupScreen;
